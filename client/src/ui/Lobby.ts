...
const LOBBY_DISPLAY_TITLE = "Drone Wars";
    ...
    const showNextUnlockModal = () => {
      ...
      if (kind === "worldSaved") {
        ...
        unlockBody.textContent =
          "All five braziers now hold Eternal Flame. The moon will not fall on this world again. Whenever you play Drone Wars, you can wander the sky without that last threat closing in. A memorial statue has been placed on the globe as a new landmark—fly by and see it. Thank you for flying for us all.";
