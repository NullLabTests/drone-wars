...
export class HUD {
  ...
  showmissileSplatter(colorHex?: number) {
    const el = document.createElement("div");
    el.className = "hud-missile-splatter";
    ...
    requestAnimationFrame(() => el.classList.add("hud-missile-splatter-animate"));
