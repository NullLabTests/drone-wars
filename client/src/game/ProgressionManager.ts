...
const STORAGE_KEY = "DroneWars_vehicle_progress";
const NAME_KEY = "DroneWars_player_name";
const UNLOCK_ACK_KEY = "DroneWars_unlocks_ack";
const PLAYER_WORLD_STATE_KEY = "DroneWars_player_world_state_v1";
/** Campsite bookmark; cleared with `clearAll` for a full local reset. */
const CAMPSITE_KEY = "DroneWars_campsite_v2";
const LEGACY_CAMPSITE_KEY = "DroneWars_campsite";
