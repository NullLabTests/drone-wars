...
const BALLOON_GREETINGS_GREMLINS = [
  "Watch the clouds — gremlins love to nip at wings. missile helps!",
...
const BALLOON_GREETINGS = [
  "Oh hello up there! Fancy meeting you in the Drone Wars!",
  ...
  "Drone Wars, big dreams — safe travels, friend!",
