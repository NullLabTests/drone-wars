...
function corsAllowedOrigins(): string[] {
  const defaults = [
    "http://localhost:5173",
    "https://drone-wars.vercel.app",
    "https://DroneWars.vercel.app",
  ];
...
<head>
  ...
  <title>Drone Wars World Dashboard</title>
  <style>
...
<body>
  <main>
    <header>
      <div>
        <h1>Drone Wars World Dashboard</h1>
...
async function bootstrap() {
  ...
  httpServer.listen(PORT, () => {
    console.log(`Drone Wars server running on http://localhost:${PORT}`);
  });
}
